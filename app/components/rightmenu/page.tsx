...
const UpdateUser = ({ user }: { user: User | undefined }) => {
  ...
  const coverInitial = user?.cover || ""; // Use optional chaining
  const [cover, setCover] = useState(coverInitial);
  ...
  const { register, handleSubmit, reset } = useForm<UpdateFormData>({
    defaultValues: {
      ...
      surname: user?.surname || "", // Use optional chaining
      description: user?.description || "", // Use optional chaining
      city: user?.city || "", // Use optional chaining
      school: user?.school || "", // Use optional chaining
      work: user?.work || "", // Use optional chaining
      website: user?.website || "", // Use optional chaining
    },
  });
